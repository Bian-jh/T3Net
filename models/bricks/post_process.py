...
class PostProcess(nn.Module):
    ...
    @torch.no_grad()
    def forward(self, outputs, target_sizes, num_select=None):
        select_box_nums_for_evaluation = self.select_box_nums_for_evaluation if num_select is None else num_select
        ...
        # select_box_nums_for_evaluation = out_logits.shape[1] # cancel num_top_queries
        print(select_box_nums_for_evaluation)
