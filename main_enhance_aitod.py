...
from util.engine import evaluate_acc, train_one_epoch_enhance_acc
...
def parse_args():
    ...
    parser.add_argument("--config-file", default="configs/enhance_config_aitodv2.py")
    parser.add_argument(
        "--mixed-precision",
        type=str,
        default=None,
