...
def test_on_dataset():
    ...
    if args.dataset == 'visdrone':
        coco_path = '/home/cii0421/datasets/VisDrone-DET2019'
        ...
        coco_path = "/home/cii0421/datasets/AI-TOD"
        dataset = CocoDetection(
            img_folder=f"{coco_path}/test/images",
            ann_file=f"{coco_path}/annotations/aitod_test_v1.json",
            transforms=None,  # the eval_transform is integrated in the model
        )
    elif args.dataset == 'aitodv2':
        coco_path = "/home/cii0421/datasets/AI-TOD"
